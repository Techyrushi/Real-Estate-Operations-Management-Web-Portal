...
<!-- Mirrored from master-admin-template.multipurposethemes.com/bs5/real-estate/auth_lockscreen.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Feb 2026 09:56:16 GMT -->
<head>
  <meta charset="utf-8">
				...
				<div class="row justify-content-center g-0">
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							...
							<div class="p-40">
								<form action="https://master-admin-template.multipurposethemes.com/bs5/real-estate/index.html" method="post">
