...
<!-- Mirrored from master-admin-template.multipurposethemes.com/bs5/real-estate/file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Feb 2026 09:56:15 GMT -->
<head>
    <meta charset="utf-8">
			...
			<div class="modal-content">
			  ...
			  <div class="modal-body pt-0 bg-white">
				  <div class="media-list media-list-divided">
					<div class="media ps-0 pt-0 pe-0 bb-1 no-shadow">
				  ...
				  <div class="py-10">
					<h2 class="fs-12 text-fade">FILES SHARED</h2>
				  </div>
				  <div class="media-list no-shadowṣ content-attach pb-30 bb-1">
					  <div class="media-list b-1 rounded bg-lightest mb-10">
						<div class="media align-items-center">
						  <a class="avatar avatar-lg mx-0" href="#">
							<img src="../images/default-50x50.gif" class="rounded0" alt="...">
						  </a>
						  <div class="media-body">
							<p class="fs-16">
							  <a class="hover-primary" href="#"><strong>Screenshot of ...rea.jpg</strong></a>
							</p>
							  12 MB
						  </div>
					  ...
					  <div class="media-list b-1 rounded bg-lightest">
						<div class="media align-items-center">
						  <a class="avatar avatar-lg mx-0 fs-32" href="#">
							<i class="fa fa-file-pdf-o"></i>
						  </a>
						  <div class="media-body">
							<p class="fs-16">
							  <a class="hover-primary" href="#"><strong>Product Certificate.pdf</strong></a>
							</p>
							  70 KB
						  </div>
						  <div class="media-right">
				  ...
				  <ul class="list-unstyled">
					<li>
						<a class="px-10 py-5 d-block" href="javascript:void(0)">
						<i class="mdi mdi-file-document text-info"></i> <span>app-mail.html</span>
						</a>
					</li>
					<li>
						<a class="px-10 py-5 d-block" href="javascript:void(0)">
						<i class="mdi mdi-file-document text-info"></i> <span>app-notes.html</span>
						</a>
					</li>
					<li>
						<a class="px-10 py-5 d-block" href="javascript:void(0)">
						<i class="mdi mdi-file-document text-info"></i> <span>app-calendar.html</span>
						</a>
					</li>
					<li>
						<a class="px-10 py-5 d-block" href="javascript:void(0)">
						<i class="mdi mdi-file-document text-info"></i> <span>app-contacts.html</span>
						</a>
					</li>
					<li>
						<a class="px-10 py-5 d-block" href="javascript:void(0)">
						<i class="mdi mdi-file-document text-info"></i> <span>app-taskboard.html</span>
						</a>
					</li>
					<li>
						<a class="px-10 py-5 d-block" href="javascript:void(0)">
						<i class="mdi mdi-file-document text-info"></i> <span>charts-c3.html</span>
						</a>
					</li>
					<li>
						<a class="px-10 py-5 d-block" href="javascript:void(0)">
						<i class="mdi mdi-file-document text-info"></i> <span>sidebar-overlay.html</span>
						</a>
					</li>
				 </ul>
			   </div>
			  <div class="modal-footer modal-footer-uniform bg-white">
				<button type="button" class="btn btn-rounded btn-danger" data-bs-dismiss="modal">Close</button>
			  </div>
			</div>
		  </div>
		</div>
...
<!-- Mirrored from master-admin-template.multipurposethemes.com/bs5/real-estate/file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Feb 2026 09:56:16 GMT -->
</html>
