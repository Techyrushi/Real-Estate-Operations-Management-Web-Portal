...
<!-- Mirrored from master-admin-template.multipurposethemes.com/bs5/real-estate/agentslist.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Feb 2026 09:56:08 GMT -->
<head>
    <meta charset="utf-8">
			...
			<div class="row">
					  ...
					  <div class="box-body">
						  <div class="text-center">
							<div class="user-contact list-inline text-center">
								...
								<a href="#" class="btn btn-circle mb-5 btn-twitter"><i class="fa-brands fa-x-twitter"></i></a>
								<a href="#" class="btn btn-circle mb-5 btn-warning"><i class="fa fa-envelope"></i></a>				
							</div>
							<h3 class="my-10"><a href="#">Isabella</a></h3>
							<h6 class="user-info mt-0 mb-10"><i class="fa fa-phone me-5"></i>+1 123 456 7890</h6>
							<p class="w-p85 mx-auto"><i class="fa fa-envelope me-5"></i> Info@dummy.com</p>
						  </div>
					  </div>
					</div>
				  </div>
				<div class="col-12 col-lg-4">
					<div class="box ribbon-box">
					  <div class="ribbon-two ribbon-two-primary"><span>Top Agent</span></div>
					  <div class="box-header no-border p-0">				
						<a href="#">
				  ...
				  <div class="col-12 col-lg-4">
					<div class="box ribbon-box">
					  <div class="ribbon-two ribbon-two-danger"><span>MD Lavel</span></div>
					  <div class="box-header no-border p-0">				
						<a href="#">
				  ...
				  <div class="col-12 col-lg-4">
					<div class="box ribbon-box">
					  <div class="ribbon-two ribbon-two-success"><span>Top Leader</span></div>
					  <div class="box-header no-border p-0">				
						<a href="#">
...
<!-- Mirrored from master-admin-template.multipurposethemes.com/bs5/real-estate/agentslist.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Feb 2026 09:56:10 GMT -->
</html>
