...
<!-- Mirrored from master-admin-template.multipurposethemes.com/bs5/real-estate/apartment.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Feb 2026 09:56:08 GMT -->
<head>
    <meta charset="utf-8">
		...
		<section class="content">			
			<div class="row">				
				<div class="col-lg-3 col-md-6 col-12">
					<div class="box">
						<div class="box-body p-0 ribbon-box">
							<div class="ribbon-two ribbon-two-success"><span>FOR SALE</span></div>
							...
							<div class="property-bx p-20">
								<div>
									...
									<h4 class="mt-0"><a href="#" class="text-primary">4BHK Lorem Court,New York</a></h4>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="box">
						<div class="box-body p-0 ribbon-box">
							<div class="ribbon-two ribbon-two-danger"><span>FOR RENT</span></div>
