  ...
  <div class="container-full">
    <div class="content-header">
        <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#unitModal" onclick="resetForm()"><i class="ti-plus"></i> Add New Unit</button>
            </div>
        </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if($unit['status'] == 'Booked') $badgeClass = 'badge-warning';
                                            if($unit['status'] == 'Sold') $badgeClass = 'badge-danger';
                                            ?>
